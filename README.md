...
* **Persistent Avatar:** Pick a profile picture from your gallery that stays saved even after restarting the app.
...
3.  **Run the App:**
    * Connect an Android device or start an Emulator (Minimum SDK 24).
...
Developed by **Mark Jomar S. Calmateo** * [GitHub](https://github.com/Jom-kowd)
